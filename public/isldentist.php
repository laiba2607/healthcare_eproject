...
<div class="profile">
        <div class="profile-header">
            <img src="https://staticconnect.marham.pk/assets/doctors/18011/dr-asdaq-asim-dentist-lahore-27_170X170.PNG" alt="Dr. Asdaq Asim">
            <div class="profile-info">
                <h1>Dr. Asdaq Asim</h1>
                <p>Dentist</p>
                <p>Dentist, Orthodontist
BDS, FCPS, (Res), ORTHODONTICS, C-Implants (Switzerland ) C- Implants (Dubai) Implantologist, Smile Design Specialist</p>
            </div>
        </div>
