...
<section class="bg-dark">
    ...
    <p>This document contains the Terms and Conditions ("Terms") governing your use of our medical healthcare website. By accessing or using this website, you agree to be bound by these Terms. If you do not agree with any of these Terms, please do not use this website.

<h4>1. Eligibility and Registration</h4>

<p>Our medical healthcare website is intended for use by individuals who are 18 years of age or older. By using this website, you represent and warrant that you are at least 18 years old. If you are under 18, you may only use this website with the involvement of a parent or guardian.

To access certain features of the website, you may need to register for an account. When registering for an account, you agree to provide accurate, current, and complete information. You are responsible for maintaining the confidentiality of your account and password and for restricting access to your computer. You agree to accept responsibility for all activities that occur under your account or password.</p>

<h4>2. Use of Website Content</h4>

<p>All content on this website, including but not limited to text, graphics, images, and information, is the property of our medical healthcare website or its licensors and is protected by copyright laws. You may not modify, copy, distribute, transmit, display, perform, reproduce, publish, license, create derivative works from, transfer, or sell any information or content obtained from this website without the prior written consent of our medical healthcare website.

You may use the content of this website for personal, non-commercial use only. Any other use is strictly prohibited and may violate copyright laws.</p>
...
Our medical healthcare website does not recommend or endorse any specific tests, physicians, products, procedures, opinions, or other information that may be mentioned on this website. Reliance on any information provided by this website is solely at your own risk.</p>

<h4>4. Limitation of Liability</h4>

<p>Our medical healthcare website shall not be liable for any direct, indirect, incidental, special, consequential, or punitive damages arising out of your access to or use of this website or any content on this website. This includes, but is not limited to, damages for loss of profits, goodwill, use, data, or other intangible losses, even if our medical healthcare website has been advised of the possibility of such damages.

In no event shall our medical healthcare website be liable for any damages arising from the use of or inability to use this website, whether based on warranty, contract, tort, or any other legal theory, and whether or not our medical healthcare website has been informed of the possibility of such damage.</p>

<h4>5. Changes to Terms & Conditions</h4>

<p>Our medical healthcare website reserves the right to update or modify these Terms at any time without prior notice. Your continued use of this website after any changes indicates your acceptance of the revised Terms. It is your responsibility to review these Terms periodically for any updates or changes.</p>
